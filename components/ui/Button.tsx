...
import { isWhatsAppHref } from "@/lib/analytics"
...
function LinkButton({ className, variant, style, ...props }: LinkButtonProps) {
  ...
  return (
    <a
      ...
      // WhatsApp en pestaña nueva: la página sigue viva y el ping de conversión no se pierde.
      {...(props.href && isWhatsAppHref(props.href) ? { target: "_blank", rel: "noopener noreferrer" } : {})}
      {...props}
    />
  )
}
